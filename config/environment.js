...
module.exports = function(environment) {
  ...
  ENV.contentSecurityPolicy = { 'default-src': ['*', '', 'data:', 'blob:', '\'unsafe-inline\'', '\'unsafe-eval\''], 'script-src': ['*', 'unsafe-inline', '\'unsafe-eval\''], 'connect-src': ['*', 'blob:', 'http://52.148.80.30:5000','http://127.0.0.1:5000', 'http://172.21.149.125:5000/', '\'unsafe-inline\''], 'img-src': ['*', 'data:', 'blob:', '\'unsafe-inline\''], 'frame-src': ['*'], 'style-src': ['*', 'data:', 'blob:', '\'unsafe-inline\''], 'font-src': ['*', 'data:', 'blob:', '\'unsafe-inline\''],
