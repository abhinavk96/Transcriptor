...
export declare namespace Statements {
    ...
    type Statement = Text | Append | Comment | Modifier | Block | Component | DynamicComponent | OpenElement | SplatElement | FlushElement | CloseElement | StaticAttr | DynamicAttr | ComponentAttr | AttrSplat | Yield | Partial | StaticArg | DynamicArg | TrustingAttr | TrustingComponentAttr | Debugger | ClientSide;
