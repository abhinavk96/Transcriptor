 ...
 */
export declare function findPlugin(target: ConfigurationTarget, plugin: string): BabelPluginConfig | undefined;
/**
 ...
 * @param plugin The name of the plugin to be located
 */
export declare function hasPlugin(target: ConfigurationTarget, plugin: string): boolean;
 ...
 */
export declare function addPlugin(target: ConfigurationTarget, plugin: BabelPluginConfig, options?: AddPluginOptions): void;
